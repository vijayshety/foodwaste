...
function floatchart() {
    ...
    $(function() {
        ...
        var chart = new ApexCharts(document.querySelector("#seo-chart4"), options);
        chart.render();
    });
    // [ seo-chart4 ] end
    ...
    $(function() {
        ...
        var chart = new ApexCharts(document.querySelector("#seo-chart5"), options);
        chart.render();
    });
    // [ seo-chart5 ] end
    ...
    $(function() {
        ...
        var chart = new ApexCharts(document.querySelector("#seo-chart6"), options);
        chart.render();
    });
    // [ seo-chart6 ] end
    ...
    $(function() {
        ...
        var chart = new ApexCharts(document.querySelector("#seo-chart7"), options);
        chart.render();
    });
    // [ seo-chart7 ] end
    ...
    $(function() {
        ...
        var chart = new ApexCharts(document.querySelector("#seo-chart8"), options);
        chart.render();
    });
    // [ seo-chart8 ] end
